        ...
        {stats.map((stat, i) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className={`rounded-lg bg-${stat.color}-50 p-3 text-${stat.color}-600`}>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-3">
            {upcomingTasks.map((task) => (
              <div 
                key={task.id}
                className="flex items-center justify-between rounded-xl border border-gray-100 bg-white p-4 shadow-sm hover:border-blue-200 transition-all"
              >
          ...
          <div className="space-y-3">
            {projects.map((project) => (
              <Link 
                ...
                className="group block rounded-xl border border-gray-100 bg-white p-4 shadow-sm hover:border-blue-200 transition-all"
              >
                <div className="flex items-center justify-between">
